...
if Source not in graph:
    ...
    smallest_distance, parent_node = dijkstra(graph, Source)
#    print("shortest distance from", Source, "to", end, "is:", smallest_distance[end])
#    print(shortest_path(parent_node, end))
    for i in smallest_distance:
       print("shortest distance from", Source, "to", i, "is:")
       print(smallest_distance[i])
       print("shortest distance from", Source, "to", i, "is:")
